...
public class UserReportController {
  ...
  private ResponseEntity<ApiResponse<List<Map<String, Object>>>> ok(String type, User user) {
  ...
  private List<Map<String, Object>> loadEntries(String type, User user) {
    ...
    if (zodiac != null && !zodiac.isBlank()) {
      List<ReportEntry> filtered =
          reportRepository.findByTypeAndZodiacAndIsActiveTrueOrderByIdAsc(
              type, zodiac.toUpperCase());
