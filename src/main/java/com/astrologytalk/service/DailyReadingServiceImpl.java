...
public class DailyReadingServiceImpl implements DailyReadingService {
  ...
  private static final Map<String, Integer> PLANET_NUMBER =
      Map.of(
          "MARS", 9, "VENUS", 6, "JUPITER", 3, "SATURN", 8, "MOON", 2, "SUN", 1, "MERCURY", 5,
          "RAHU", 4, "KETU", 7);

  private static final Map<String, String> PLANET_COLOR =
      Map.of(
          "MARS",
          "Red",
          "VENUS",
  ...
  private String pickText(String signature, String category, Random rnd) {
    List<ContentEntry> options =
        contentRepo.findBySignatureAndCategoryAndLanguage(signature, category, LANG);
  ...
  private DailyReadingResponse toResponseWithZodiac(
      DailyReading r, String zodiac, boolean hasZodiac) {
